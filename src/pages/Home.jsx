      ...
      <section className="hero">
        <div className="container">
          <div className="hero-content">
            ...
            <p>
              Especialistas em silos e secadores de grãos.
              <br />
        ...
        <div className="container">
          <div className="about-hero">
            ...
            <p className="hero-text">
              Com expertise em silos e secadores de grãos, fornecemos soluções
              completas para o setor agrícola e industrial, focadas na
              eficiência e durabilidade. Atuamos de forma personalizada para
              atender às necessidades específicas de nossos clientes, garantindo
              equipamentos de alta performance para o mercado nacional.
            </p>
          </div>
          ...
          <div className="about-content">
            <div className="content-grid">
              ...
              <div className="content-block">
                <h2>Nossa Visão</h2>
                <p>
                  Ser a empresa líder em equipamentos agroindustriais,
                  reconhecida pela qualidade dos produtos, inovação tecnológica
                  e compromisso com a satisfação dos clientes.
                </p>
              </div>
